...
export interface TaikoBridgeL1Interface extends utils.Interface {
  functions: {
...
export interface MessageSentEventObject {
  msgHash: string;
  message: IBridge.MessageStructOutput;
}
export type MessageSentEvent = TypedEvent<
  [string, IBridge.MessageStructOutput],
...
export interface TaikoBridgeL1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TaikoBridgeL1Interface;
